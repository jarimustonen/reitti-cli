...
fn stop() -> Value {
    json!({"type":"object","additionalProperties":false,"required":["ref","id","name","code","platform","coordinates","distance_m","modes","wheelchair_boarding","service_area","reittiopas_url"],"properties":{"ref":{"type":"string"},"id":{"type":"string"},"name":{"type":"string"},"code":{"type":["string","null"]},"platform":{"type":["string","null"]},"coordinates":{"oneOf":[{"$ref":"#/$defs/coordinates"},{"type":"null"}]},"distance_m":{"type":["number","null"],"minimum":0},"modes":{"type":"array","items":{"enum":["bus","tram","rail","subway","ferry"]}},"wheelchair_boarding":{"enum":["accessible","not_accessible","unknown"]},"service_area":{"enum":["inside","outside","unknown"]},"reittiopas_url":{"type":"string","pattern":"^https://reittiopas\\.hsl\\.fi/pysakit/HSL%3A[A-Za-z0-9_.-]+$"}}})
}
fn step() -> Value {
